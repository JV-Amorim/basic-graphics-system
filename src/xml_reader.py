...
class XmlReader:
  ...
  def get_individual_points_data(self):
    xml = self.xml_root
    point_1 = Point3D.create_from_xml_attrib_dict(xml[2].attrib)
    point_2 = Point3D.create_from_xml_attrib_dict(xml[3].attrib)
    point_3 = Point3D.create_from_xml_attrib_dict(xml[4].attrib)
    return [point_1, point_2, point_3]

  def get_lines_data(self):
    xml = self.xml_root
    point_1_1 = Point3D.create_from_xml_attrib_dict(xml[5][0].attrib)
    point_1_2 = Point3D.create_from_xml_attrib_dict(xml[5][1].attrib)
    point_2_1 = Point3D.create_from_xml_attrib_dict(xml[6][0].attrib)
    point_2_2 = Point3D.create_from_xml_attrib_dict(xml[6][1].attrib)
  ...
  def get_polygon_data(self):
    xml = self.xml_root
    point_1 = Point3D.create_from_xml_attrib_dict(xml[7][0].attrib)
    point_2 = Point3D.create_from_xml_attrib_dict(xml[7][1].attrib)
    point_3 = Point3D.create_from_xml_attrib_dict(xml[7][2].attrib)
    point_4 = Point3D.create_from_xml_attrib_dict(xml[7][3].attrib)
